...
public class ButtonWithMyPrefSize extends Button implements IComponentWithMyPrefSize {

	private MyPrefSize myPrefSize;

	public ButtonWithMyPrefSize(String text, int myPrefWidth, int myPrefHeight, boolean percentageWidth, boolean percentageHeight) {
		super(text);
